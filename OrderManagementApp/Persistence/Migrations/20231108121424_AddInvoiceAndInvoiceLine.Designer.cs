...
namespace OrderManagementApp.Persistence.Migrations
{
    ...
    [Migration("20231108121424_AddInvoiceAndInvoiceLine")]
    partial class AddInvoiceAndInvoiceLine
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderManagementApp.Domain.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderManagementApp.Domain.Entities.InvoiceLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderManagementApp.Domain.Entities.InvoiceLine", b =>
                {
                    b.HasOne("OrderManagementApp.Domain.Entities.Invoice", "Invoice")
